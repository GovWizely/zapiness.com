 ...
 */
function(){var t,e;t=this.jQuery||window.jQuery,e=t(window),t.fn.stick_in_parent=function(n){var i,o,a,r,s,l,u,c,d,p,f,h;for(null==n&&(n={}),h=n.sticky_class,l=n.inner_scrolling,f=n.recalc_every,p=n.parent,d=n.offset_top,c=n.spacer,a=n.bottoming,null==d&&(d=0),null==p&&(p=void 0),null==l&&(l=!0),null==h&&(h="is_stuck"),i=t(document),null==a&&(a=!0),r=function(n,o,r,s,u,m,g,v){var y,w,b,I,x,C,_,k,S,T,E,L;if(!n.data("sticky_kit")){if(n.data("sticky_kit",!0),x=i.height(),_=n.parent(),null!=p&&(_=_.closest(p)),!_.length)throw"failed to find stick parent";if(b=!1,y=!1,E=null!=c?c&&n.closest(c):t("<div />"),E&&E.css("position",n.css("position")),k=function(){var t,e,a;if(!v)return x=i.height(),t=parseInt(_.css("border-top-width"),10),e=parseInt(_.css("padding-top"),10),o=parseInt(_.css("padding-bottom"),10),r=_.offset().top+t+e,s=_.height(),b&&(b=!1,y=!1,null==c&&(n.insertAfter(E),E.detach()),n.css({position:"",top:"",width:"",bottom:""}).removeClass(h),a=!0),u=n.offset().top-(parseInt(n.css("margin-top"),10)||0)-d,m=n.outerHeight(!0),g=n.css("float"),E&&E.css({width:n.outerWidth(!0),height:m,display:n.css("display"),"vertical-align":n.css("vertical-align"),"float":g}),a?L():void 0},k(),m!==s)return I=void 0,C=d,T=f,L=function(){var t,p,w,S,L,M;if(!v)return w=!1,null!=T&&(T-=1,T<=0&&(T=f,k(),w=!0)),w||i.height()===x||(k(),w=!0),S=e.scrollTop(),null!=I&&(p=S-I),I=S,b?(a&&(L=S+m+C>s+r,y&&!L&&(y=!1,n.css({position:"fixed",bottom:"",top:C}).trigger("sticky_kit:unbottom"))),S<u&&(b=!1,C=d,null==c&&("left"!==g&&"right"!==g||n.insertAfter(E),E.detach()),t={position:"",width:"",top:""},n.css(t).removeClass(h).trigger("sticky_kit:unstick")),l&&(M=e.height(),m+d>M&&(y||(C-=p,C=Math.max(M-m,C),C=Math.min(d,C),b&&n.css({top:C+"px"}))))):S>u&&(b=!0,t={position:"fixed",top:C},t.width="border-box"===n.css("box-sizing")?n.outerWidth()+"px":n.width()+"px",n.css(t).addClass(h),null==c&&(n.after(E),"left"!==g&&"right"!==g||E.append(n)),n.trigger("sticky_kit:stick")),b&&a&&(null==L&&(L=S+m+C>s+r),!y&&L)?(y=!0,"static"===_.css("position")&&_.css({position:"relative"}),n.css({position:"absolute",bottom:o,top:"auto"}).trigger("sticky_kit:bottom")):void 0},S=function(){return k(),L()},w=function(){if(v=!0,e.off("touchmove",L),e.off("scroll",L),e.off("resize",S),t(document.body).off("sticky_kit:recalc",S),n.off("sticky_kit:detach",w),n.removeData("sticky_kit"),n.css({position:"",bottom:"",top:"",width:""}),_.position("position",""),b)return null==c&&("left"!==g&&"right"!==g||n.insertAfter(E),E.remove()),n.removeClass(h)},e.on("touchmove",L),e.on("scroll",L),e.on("resize",S),t(document.body).on("sticky_kit:recalc",S),n.on("sticky_kit:detach",w),setTimeout(L,0)}},s=0,u=this.length;s<u;s++)o=this[s],r(t(o));return this}}.call(this),/*
...
function(){function t(){var t=!1;t&&u("keydown",o),y.keyboardSupport&&!t&&l("keydown",o)}function e(){if(document.body){var e=document.body,n=document.documentElement,i=window.innerHeight,o=e.scrollHeight;if(C=document.compatMode.indexOf("CSS")>=0?n:e,g=e,t(),x=!0,top!=self)b=!0;else if(o>i&&(e.offsetHeight<=i||n.offsetHeight<=i)&&(n.style.height="auto",C.offsetHeight<=i)){var a=document.createElement("div");a.style.clear="both",e.appendChild(a)}y.fixedBackground||w||(e.style.backgroundAttachment="scroll",n.style.backgroundAttachment="scroll")}}function n(t,e,n,i){if(i||(i=1e3),d(e,n),1!=y.accelerationMax){var o=+new Date,a=o-E;if(a<y.accelerationDelta){var r=(1+30/a)/2;r>1&&(r=Math.min(r,y.accelerationMax),e*=r,n*=r)}E=+new Date}if(S.push({x:e,y:n,lastX:e<0?.99:-.99,lastY:n<0?.99:-.99,start:+new Date}),!T){var s=t===document.body,l=function(o){for(var a=+new Date,r=0,u=0,c=0;c<S.length;c++){var d=S[c],p=a-d.start,f=p>=y.animationTime,h=f?1:p/y.animationTime;y.pulseAlgorithm&&(h=m(h));var g=d.x*h-d.lastX>>0,v=d.y*h-d.lastY>>0;r+=g,u+=v,d.lastX+=g,d.lastY+=v,f&&(S.splice(c,1),c--)}s?window.scrollBy(r,u):(r&&(t.scrollLeft+=r),u&&(t.scrollTop+=u)),e||n||(S=[]),S.length?A(l,t,i/y.frameRate+1):T=!1};A(l,t,0),T=!0}}function i(t){x||e();var i=t.target,o=s(i);if(!o||t.defaultPrevented||c(g,"embed")||c(i,"embed")&&/\.pdf/i.test(i.src))return!0;var a=t.wheelDeltaX||0,r=t.wheelDeltaY||0;return a||r||(r=t.wheelDelta||0),!(y.touchpadSupport||!p(r))||(Math.abs(a)>1.2&&(a*=y.stepSize/120),Math.abs(r)>1.2&&(r*=y.stepSize/120),n(o,-a,-r),void t.preventDefault())}function o(t){var e=t.target,i=t.ctrlKey||t.altKey||t.metaKey||t.shiftKey&&t.keyCode!==k.spacebar;if(/input|textarea|select|embed/i.test(e.nodeName)||e.isContentEditable||t.defaultPrevented||i)return!0;if(c(e,"button")&&t.keyCode===k.spacebar)return!0;var o,a=0,r=0,l=s(g),u=l.clientHeight;switch(l==document.body&&(u=window.innerHeight),t.keyCode){case k.up:r=-y.arrowScroll;break;case k.down:r=y.arrowScroll;break;case k.spacebar:o=t.shiftKey?1:-1,r=-o*u*.9;break;case k.pageup:r=.9*-u;break;case k.pagedown:r=.9*u;break;case k.home:r=-l.scrollTop;break;case k.end:var d=l.scrollHeight-l.scrollTop-u;r=d>0?d+10:0;break;case k.left:a=-y.arrowScroll;break;case k.right:a=y.arrowScroll;break;default:return!0}n(l,a,r),t.preventDefault()}function a(t){g=t.target}function r(t,e){for(var n=t.length;n--;)L[P(t[n])]=e;return e}function s(t){var e=[],n=C.scrollHeight;do{var i=L[P(t)];if(i)return r(e,i);if(e.push(t),n===t.scrollHeight){if(!b||C.clientHeight+10<n)return r(e,document.body)}else if(t.clientHeight+10<t.scrollHeight&&(overflow=getComputedStyle(t,"").getPropertyValue("overflow-y"),"scroll"===overflow||"auto"===overflow))return r(e,t)}while(t=t.parentNode)}function l(t,e,n){window.addEventListener(t,e,n||!1)}function u(t,e,n){window.removeEventListener(t,e,n||!1)}function c(t,e){return(t.nodeName||"").toLowerCase()===e.toLowerCase()}function d(t,e){t=t>0?1:-1,e=e>0?1:-1,I.x===t&&I.y===e||(I.x=t,I.y=e,S=[],E=0)}function p(t){if(t){t=Math.abs(t),_.push(t),_.shift(),clearTimeout(M);var e=_[0]==_[1]&&_[1]==_[2],n=f(_[0],120)&&f(_[1],120)&&f(_[2],120);return!(e||n)}}function f(t,e){return Math.floor(t/e)==t/e}function h(t){var e,n,i;return t*=y.pulseScale,t<1?e=t-(1-Math.exp(-t)):(n=Math.exp(-1),t-=1,i=1-Math.exp(-t),e=n+i*(1-n)),e*y.pulseNormalize}function m(t){return t>=1?1:t<=0?0:(1==y.pulseNormalize&&(y.pulseNormalize/=h(1)),h(t))}var g,v={frameRate:150,animationTime:500,stepSize:150,pulseAlgorithm:!0,pulseScale:6,pulseNormalize:1,accelerationDelta:20,accelerationMax:1,keyboardSupport:!0,arrowScroll:50,touchpadSupport:!0,fixedBackground:!0,excluded:""},y=v,w=!1,b=!1,I={x:0,y:0},x=!1,C=document.documentElement,_=[120,120,120],k={left:37,up:38,right:39,down:40,spacebar:32,pageup:33,pagedown:34,end:35,home:36},y=v,S=[],T=!1,E=+new Date,L={};setInterval(function(){L={}},1e4);var M,P=function(){var t=0;return function(e){return e.uniqueID||(e.uniqueID=t++)}}(),A=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||function(t,e,n){window.setTimeout(t,n||1e3/60)}}(),z=/chrome/i.test(window.navigator.userAgent),$="onmousewheel"in document;$&&z&&(l("mousedown",a),l("mousewheel",i),l("load",e))}(),/*!
